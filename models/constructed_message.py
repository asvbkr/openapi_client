...
class ConstructedMessage(object):
    ...
    def __init__(self, sender=None, timestamp=None, link=None, body=None):  # noqa: E501
        """ConstructedMessage - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def sender(self):
        """Gets the sender of this ConstructedMessage.  # noqa: E501

        User who sent this message  # noqa: E501

        :return: The sender of this ConstructedMessage.  # noqa: E501
        :rtype: User
        """
        return self._sender
    ...
    def sender(self, sender):
        """Sets the sender of this ConstructedMessage.

        User who sent this message  # noqa: E501

        :param sender: The sender of this ConstructedMessage.  # noqa: E501
        :type: User
        """
        # Может отсутствовать для каналов с анонимной публикацией (т.е. у которых не установлено свойство "Подписывать сообщения")
        # if sender is None:
    ...
    @property
    def timestamp(self):
        """Gets the timestamp of this ConstructedMessage.  # noqa: E501

        Unix-time when message has been created  # noqa: E501

        :return: The timestamp of this ConstructedMessage.  # noqa: E501
        :rtype: int
        """
    ...
    def timestamp(self, timestamp):
        """Sets the timestamp of this ConstructedMessage.

        Unix-time when message has been created  # noqa: E501

        :param timestamp: The timestamp of this ConstructedMessage.  # noqa: E501
        :type: int
        """
    ...
    @property
    def link(self):
        """Gets the link of this ConstructedMessage.  # noqa: E501

        Any linked message: forward or reply  # noqa: E501

        :return: The link of this ConstructedMessage.  # noqa: E501
        :rtype: LinkedMessage
        """
        return self._link
    ...
    @link.setter
    def link(self, link):
        """Sets the link of this ConstructedMessage.

        Any linked message: forward or reply  # noqa: E501

        :param link: The link of this ConstructedMessage.  # noqa: E501
        :type: LinkedMessage
        """
    ...
    @property
    def body(self):
        """Gets the body of this ConstructedMessage.  # noqa: E501

        Body of created message. Text + attachments  # noqa: E501

        :return: The body of this ConstructedMessage.  # noqa: E501
        :rtype: MessageBody
        """
        return self._body
    ...
    @body.setter
    def body(self, body):
        """Sets the body of this ConstructedMessage.

        Body of created message. Text + attachments  # noqa: E501

        :param body: The body of this ConstructedMessage.  # noqa: E501
        :type: MessageBody
        """
        if body is None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConstructedMessage):
            return False
