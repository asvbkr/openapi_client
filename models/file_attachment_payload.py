...
class FileAttachmentPayload(AttachmentPayload):
    ...
    def __init__(self, url=None, file_id=None, token=None):  # noqa: E501
    ...
    @property
    def file_id(self):
        """Gets the file_id of this FileAttachmentPayload.  # noqa: E501

        Uploaded file unique identifier  # noqa: E501

        :return: The file_id of this FileAttachmentPayload.  # noqa: E501
        :rtype: int
        """
    ...
    def file_id(self, file_id):
        """Sets the file_id of this FileAttachmentPayload.

        Uploaded file unique identifier  # noqa: E501

        :param file_id: The file_id of this FileAttachmentPayload.  # noqa: E501
        :type: int
        """
        if file_id is None:
    ...
    def token(self):
        ...
        Use `token` along with `fileId` in case when you are trying to reuse the same attachment in other message  # noqa: E501
