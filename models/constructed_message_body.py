...
class ConstructedMessageBody(object):
    ...
    def __init__(self, text=None, attachments=None, markup=None, format=None):  # noqa: E501
        """ConstructedMessageBody - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def text(self):
        """Gets the text of this ConstructedMessageBody.  # noqa: E501

        Message text  # noqa: E501

        :return: The text of this ConstructedMessageBody.  # noqa: E501
        :rtype: str
        """
        return self._text
    ...
    @text.setter
    def text(self, text):
        """Sets the text of this ConstructedMessageBody.

        Message text  # noqa: E501

        :param text: The text of this ConstructedMessageBody.  # noqa: E501
        :type: str
        """
        if text is not None and len(text) > 4000:
            raise ValueError("Invalid value for `text`, length must be less than or equal to `4000`")  # noqa: E501

        self._text = text

    @property
    def attachments(self):
        """Gets the attachments of this ConstructedMessageBody.  # noqa: E501

        Message attachments. See `AttachmentRequest` and it's inheritors for full information  # noqa: E501

        :return: The attachments of this ConstructedMessageBody.  # noqa: E501
    ...
    def attachments(self, attachments):
        """Sets the attachments of this ConstructedMessageBody.

        Message attachments. See `AttachmentRequest` and it's inheritors for full information  # noqa: E501

        :param attachments: The attachments of this ConstructedMessageBody.  # noqa: E501
    ...
    @property
    def markup(self):
        """Gets the markup of this ConstructedMessageBody.  # noqa: E501

        Text markup  # noqa: E501

        :return: The markup of this ConstructedMessageBody.  # noqa: E501
    ...
    def markup(self, markup):
        """Sets the markup of this ConstructedMessageBody.

        Text markup  # noqa: E501

        :param markup: The markup of this ConstructedMessageBody.  # noqa: E501
    ...
    @property
    def format(self):
        """Gets the format of this ConstructedMessageBody.  # noqa: E501

        Message text format. If set,   # noqa: E501

        :return: The format of this ConstructedMessageBody.  # noqa: E501
        :rtype: TextFormat
        """
        return self._format
    ...
    def format(self, format):
        """Sets the format of this ConstructedMessageBody.

        Message text format. If set,   # noqa: E501

        :param format: The format of this ConstructedMessageBody.  # noqa: E501
        :type: TextFormat
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConstructedMessageBody):
            return False
