...
class MediaAttachmentPayload(AttachmentPayload):
    ...
    def __init__(self, url=None, id=None, token=None):  # noqa: E501
    ...
    @property
    def id(self):
        """Gets the id of this MediaAttachmentPayload.  # noqa: E501

        Unique identifier of media attachment  # noqa: E501

        :return: The id of this MediaAttachmentPayload.  # noqa: E501
        :rtype: int
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this MediaAttachmentPayload.

        Unique identifier of media attachment  # noqa: E501

        :param id: The id of this MediaAttachmentPayload.  # noqa: E501
        :type: int
        """
        if id is None:
    ...
    def token(self):
        ...
        Use `token` along with `id` in case when you are trying to reuse the same attachment in other message  # noqa: E501
