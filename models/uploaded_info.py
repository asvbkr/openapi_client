...
class UploadedInfo(object):
    ...
    @property
    def id(self):
        """Gets the id of this UploadedInfo.  # noqa: E501

        Uploaded file unique identifier  # noqa: E501

        :return: The id of this UploadedInfo.  # noqa: E501
        :rtype: int
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this UploadedInfo.

        Uploaded file unique identifier  # noqa: E501

        :param id: The id of this UploadedInfo.  # noqa: E501
        :type: int
        """
        if id is None:
