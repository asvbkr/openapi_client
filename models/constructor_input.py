...
class ConstructorInput(object):
    ...
    discriminator_value_class_map = {
        'message': 'MessageConstructorInput',
        'callback': 'CallbackConstructorInput'
    }

    def __init__(self, input_type=None):  # noqa: E501
        """ConstructorInput - a model defined in OpenAPI"""  # noqa: E501

        self._input_type = None
        self.discriminator = 'input_type'

        self.input_type = input_type

    @property
    def input_type(self):
        """Gets the input_type of this ConstructorInput.  # noqa: E501


        :return: The input_type of this ConstructorInput.  # noqa: E501
        :rtype: str
        """
    ...
    def input_type(self, input_type):
        """Sets the input_type of this ConstructorInput.


        :param input_type: The input_type of this ConstructorInput.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConstructorInput):
            return False
