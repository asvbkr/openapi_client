...
class MessageConstructorInput(ConstructorInput):
    ...
    def __init__(self, input_type='message', messages=None):  # noqa: E501
        """MessageConstructorInput - a model defined in OpenAPI"""  # noqa: E501
        super(MessageConstructorInput, self).__init__(input_type)
        self._messages = None
    ...
    @property
    def messages(self):
        """Gets the messages of this MessageConstructorInput.  # noqa: E501
    ...
    def messages(self, messages):
        """Sets the messages of this MessageConstructorInput.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MessageConstructorInput):
            return False
