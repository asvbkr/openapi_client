...
class ChatButton(Button):
    ...
    def chat_title(self, chat_title):
        ...
        :type: str
        """
        if chat_title is not None and len(chat_title) > 200:
            raise ValueError("Invalid value for `chat_title`, length must be less than or equal to `200`")  # noqa: E501
    ...
    def chat_description(self, chat_description):
        ...
        :type: str
        """
        if chat_description is not None and len(chat_description) > 400:
            raise ValueError("Invalid value for `chat_description`, length must be less than or equal to `400`")  # noqa: E501
    ...
    def start_payload(self, start_payload):
        ...
        :type: str
        """
        if start_payload is not None and len(start_payload) > 512:
            raise ValueError("Invalid value for `start_payload`, length must be less than or equal to `512`")  # noqa: E501
