...
class ChatMember(UserWithPhoto):
    ...
    def __init__(self, description=None, user_id=None, name=None, username=None, avatar_url=None, full_avatar_url=None, last_access_time=None, is_owner=None, is_admin=None, join_time=None,
                 permissions=None):  # noqa: E501
        """ChatMember - a model defined in OpenAPI"""  # noqa: E501

        super(ChatMember, self).__init__(description, user_id, name, username, avatar_url, full_avatar_url)
