...
class UserWithPhoto(User):
    ...
    def __init__(self, description=None, user_id=None, name=None, username=None, avatar_url=None, full_avatar_url=None):  # noqa: E501
        """UserWithPhoto - a model defined in OpenAPI"""  # noqa: E501

        super(UserWithPhoto, self).__init__(user_id, name, username)
