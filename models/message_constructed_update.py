...
class MessageConstructedUpdate(Update):
    ...
    def __init__(self, timestamp=None, session_id=None, message=None, update_type='message_constructed'):  # noqa: E501
        """MessageConstructedUpdate - a model defined in OpenAPI"""  # noqa: E501
        super(MessageConstructedUpdate, self).__init__(update_type, timestamp)
    ...
    @property
    def session_id(self):
        """Gets the session_id of this MessageConstructedUpdate.  # noqa: E501

        Constructor session identifier  # noqa: E501

        :return: The session_id of this MessageConstructedUpdate.  # noqa: E501
        :rtype: str
        """
    ...
    def session_id(self, session_id):
        """Sets the session_id of this MessageConstructedUpdate.
    ...
    @property
    def message(self):
        """Gets the message of this MessageConstructedUpdate.  # noqa: E501


        :return: The message of this MessageConstructedUpdate.  # noqa: E501
        :rtype: ConstructedMessage
        """
        return self._message

    @message.setter
    def message(self, message):
        """Sets the message of this MessageConstructedUpdate.


        :param message: The message of this MessageConstructedUpdate.  # noqa: E501
        :type: ConstructedMessage
        """
        if message is None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MessageConstructedUpdate):
            return False
