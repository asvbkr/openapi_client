...
class Chat(object):
    ...
    def __init__(self, chat_id=None, type=None, status=None, title=None, icon=None, last_event_time=None, participants_count=None, owner_id=None, participants=None, is_public=None, link=None, description=None, dialog_with_user=None):  # noqa: E501
