...
class BotInfo(UserWithPhoto):
    ...
    def __init__(self, description=None, user_id=None, name=None, username=None, avatar_url=None, full_avatar_url=None, commands=None):  # noqa: E501
        """BotInfo - a model defined in OpenAPI"""  # noqa: E501

        super(BotInfo, self).__init__(description, user_id, name, username, avatar_url, full_avatar_url)
        self._commands = None
