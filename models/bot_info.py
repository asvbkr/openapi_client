...
class BotInfo(UserWithPhoto):
    ...
    def __init__(self, user_id=None, name=None, username=None, avatar_url=None, full_avatar_url=None, commands=None, description=None):  # noqa: E501
        """BotInfo - a model defined in OpenAPI"""  # noqa: E501

        super(BotInfo, self).__init__(user_id, name, username, avatar_url, full_avatar_url)
        self._commands = None
