...
from .constructor_input import ConstructorInput


class CallbackConstructorInput(ConstructorInput):
    ...
    def __init__(self, input_type='callback', payload=None):  # noqa: E501
        """CallbackConstructorInput - a model defined in OpenAPI"""  # noqa: E501
        super(CallbackConstructorInput, self).__init__(input_type)
        self._payload = None
    ...
    @property
    def payload(self):
        """Gets the payload of this CallbackConstructorInput.  # noqa: E501

        Pressed button payload  # noqa: E501

        :return: The payload of this CallbackConstructorInput.  # noqa: E501
        :rtype: str
        """
    ...
    def payload(self, payload):
        """Sets the payload of this CallbackConstructorInput.

        Pressed button payload  # noqa: E501

        :param payload: The payload of this CallbackConstructorInput.  # noqa: E501
        :type: str
        """
        if payload is None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CallbackConstructorInput):
            return False
