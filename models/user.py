...
class User(object):
    ...
    def __init__(self, user_id=None, name=None, username=None, is_bot=None, last_activity_time=None):  # noqa: E501
    ...
    def last_activity_time(self):
        ...
        Time of last user activity in TamTam (Unix timestamp in milliseconds). Can be outdated if user disabled its "online" status in settings  # noqa: E501
    ...
    def last_activity_time(self, last_activity_time):
        ...
        :param last_activity_time: The is_bot of this User.  # noqa: E501
        :type: int
        """
