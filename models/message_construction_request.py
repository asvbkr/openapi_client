...
class MessageConstructionRequest(Update):
    ...
    def __init__(self, timestamp=None, user=None, user_locale=None, session_id=None, data=None, input=None, update_type='message_construction_request'):  # noqa: E501
        """MessageConstructionRequest - a model defined in OpenAPI"""  # noqa: E501
        super(MessageConstructionRequest, self).__init__(update_type, timestamp)
        self._user = None
    ...
    @property
    def user(self):
        """Gets the user of this MessageConstructionRequest.  # noqa: E501

        User who initiated this request  # noqa: E501

        :return: The user of this MessageConstructionRequest.  # noqa: E501
        :rtype: UserWithPhoto
        """
        return self._user
    ...
    @user.setter
    def user(self, user):
        """Sets the user of this MessageConstructionRequest.

        User who initiated this request  # noqa: E501

        :param user: The user of this MessageConstructionRequest.  # noqa: E501
        :type: UserWithPhoto
        """
        if user is None:
    ...
    def user_locale(self, user_locale):
        """Sets the user_locale of this MessageConstructionRequest.

        Current user locale in IETF BCP 47 format  # noqa: E501

        :param user_locale: The user_locale of this MessageConstructionRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def session_id(self):
        """Gets the session_id of this MessageConstructionRequest.  # noqa: E501

        Constructor session identifier  # noqa: E501

        :return: The session_id of this MessageConstructionRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def session_id(self, session_id):
        """Sets the session_id of this MessageConstructionRequest.

        Constructor session identifier  # noqa: E501

        :param session_id: The session_id of this MessageConstructionRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def data(self):
        """Gets the data of this MessageConstructionRequest.  # noqa: E501

        data received from previous `ConstructorAnswer`  # noqa: E501

        :return: The data of this MessageConstructionRequest.  # noqa: E501
        :rtype: str
        """
        return self._data
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this MessageConstructionRequest.
    ...
    @property
    def input(self):
        """Gets the input of this MessageConstructionRequest.  # noqa: E501

        User's input. It can be message (text/attachments) or simple button's callback  # noqa: E501

        :return: The input of this MessageConstructionRequest.  # noqa: E501
        :rtype: ConstructorInput
        """
        return self._input

    @input.setter
    def input(self, input):
        """Sets the input of this MessageConstructionRequest.

        User's input. It can be message (text/attachments) or simple button's callback  # noqa: E501

        :param input: The input of this MessageConstructionRequest.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MessageConstructionRequest):
            return False
