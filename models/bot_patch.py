...
class BotPatch(object):
    ...
    def username(self, username):
        ...
        if username is not None and not re.search(r'[a-z]+[a-z0-9-_]*', username):  # noqa: E501
            raise ValueError(r"Invalid value for `username`, must be a follow pattern or equal to `/[a-z]+[a-z0-9-_]*/`")  # noqa: E501
